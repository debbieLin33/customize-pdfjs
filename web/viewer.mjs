...
document.addEventListener('DOMContentLoaded', (event) => {
  // trigger keydown event on #findInput input
  ...
  let event1 = new KeyboardEvent('keydown', {
    ...
    code: 'Enter', // The code of the key pressed
    charCode: 0, // The Unicode character code for the Enter key is 0
    keyCode: 13 // The numeric key code for the Enter key
  });
  // Dispatch the event
